...
node_file_name = './result/sphere_nodes.txt'
element_file_name = './result/sphere_elements.txt'
neighbor_file_name = './result/sphere_element_neighbors.txt'
tri_pair_file_name = './result/sphere_tri_pairs.txt'
